# Stable IDE config for Neovim

This config is based on, and modified from, LunarVim's [nvim-basic-ide](https://github.com/LunarVim/nvim-basic-ide) linked in their [Neovim-from-scratch](https://github.com/LunarVim/Neovim-from-scratch) repository that I discovered after going through most of the [Neovim IDE from Scratch Youtube Playlist](https://www.youtube.com/watch?v=ctH-a-1eUME&list=PLhoH5vyxr6Qq41NFL4GvhFp-WLd5xzIzZ).

**Note**: The original `README.md` didn't include the fact that this config supports `lazygit`. This can be installed on any machine following the instructions in [the jesseduffield/lazygit `README.md`](https://github.com/jesseduffield/lazygit#readme) 

## Original `README.md` Install Information
...
Just clone it into your `nvim` directory
